function displayunreadcountintabforowa_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
displayunreadcountintabforowa_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				displayunreadcountintabforowa_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
displayunreadcountintabforowa_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
displayunreadcountintabforowa_xmlhttpRequester.prototype.setupRequestEvent =
